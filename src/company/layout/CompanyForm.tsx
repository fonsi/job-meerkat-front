...
export const CompanyForm = ({ onSuccess }: CompanyFormProps) => {
    ...
    const handleOnNameChanged: ChangeEventHandler<HTMLInputElement> = (
        event,
    ) => {
        setName(event.currentTarget.value);
    };

    const handleOnHomePageChanged: ChangeEventHandler<HTMLInputElement> = (
        event,
    ) => {
            ...
            <FormRow>
                ...
                <FormGroup error={homePageError}>
                    ...
                    <Input
                        ...
                        onChange={handleOnHomePageChanged}
                        value={homePage}
                        disabled={isProcessing}
                    />
                </FormGroup>
